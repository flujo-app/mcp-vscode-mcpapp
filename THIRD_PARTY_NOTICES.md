...
- [OpenVSCode Server](https://github.com/gitpod-io/openvscode-server), MIT License.
...
`third_party`; standalone archives place those copies under `licenses/upstream`
and add a generated production-dependency license inventory under
`licenses/npm`.
